...
const apiUrlPost = 'https://djangostartup.work/api/post/'
const apiUrlComment = 'https://djangostartup.work/api/comment/'
...
export const fetchAsyncPostComment = createAsyncThunk('comment/post', async (comment: PROPS_COMMENT) => {
